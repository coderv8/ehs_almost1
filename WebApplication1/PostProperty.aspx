...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-2">
                                <label class="radio-inline">
                                    <asp:RadioButton GroupName="grpPropertyOption" ID="rdbSell" runat="server" Text="Sell" AutoPostBack="true" Checked="true" OnCheckedChanged="rdbSell_CheckedChanged" />
                                    <%--<input type="radio" id="femaleRadio" value="Female">Female--%>
                                </label>
                            </div>
                            <div class="col-sm-2">
        ...
        <br />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <asp:RangeValidator runat="server" id="rngInitialDeposit" Enabled="true" controltovalidate="txtInitialDeposit" type="Currency" minimumvalue="5000" maximumvalue="10000" ForeColor="Red" errormessage="Initial Deposit should be between 5000 to 10000!" />
                </div>
            </div>
                <br />
           <br />
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <asp:RangeValidator runat="server" id="rngPriceRange" controltovalidate="txtPriceRange" type="Integer" minimumvalue="10000" maximumvalue="100000" ForeColor="Red" errormessage="Price Range should be between 10000 to 100000!" />
                </div>
            </div>
        ...
        <div class="form-group">
                    ...
                    <div class="col-sm-12">
                         <asp:RegularExpressionValidator runat="server" id="rexDescription" Controltovalidate="txtDesc" Display="Dynamic" validationexpression="[0-9a-zA-Z #,-]{1,250}" ForeColor="Red" errormessage="Description should be maximum of 250 letters!" />
                    </div>
                </div>
                <br />
           <br />   <br />   
